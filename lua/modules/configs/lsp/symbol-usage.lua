local symbol_usage_config = function()
  ...
  hl(0, "SymbolUsageDef", { bg = bg_color, fg = h("Type").fg, italic = true })
  hl(0, "SymbolUsageImpl", { bg = bg_color, fg = h("@keyword").fg, italic = true })
